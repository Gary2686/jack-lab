...
window.DATA.publications = {
  ...
  topics: [
    ...
    { id: "hci", label: { zh: "HCI 與使用者行為", en: "HCI & User Behavior" } },
    { id: "security", label: { zh: "資訊安全與組織行為", en: "Information Security & Organizational Behavior" } },
    { id: "ecommerce", label: { zh: "電子商務與數位服務", en: "E-Commerce & Digital Services" } },
    { id: "isd", label: { zh: "資訊系統開發與團隊", en: "IS Development & Teams" } },
  ...
  items: [
    ...
    {
      id: "j-2025-aics-quality-attributes", type: "journal", year: 2025, topics: ["ai", "hci", "service"], featured: true,
    ...
    {
      id: "j-2025-team-resilience-isd", type: "journal", year: 2025, topics: ["isd"], featured: true,
    ...
    {
      id: "j-2025-podcast-task-technology-fit", type: "journal", year: 2025, topics: ["hci", "ecommerce"], featured: false,
    ...
    {
      id: "j-2025-live-streaming-norm-violation", type: "journal", year: 2025, topics: ["ecommerce", "hci"], featured: false,
    ...
    {
      id: "j-2025-boutique-bags-subscription", type: "journal", year: 2025, topics: ["ecommerce", "service"], featured: false,
    ...
    {
      id: "j-2024-internet-banking-trust-transfer", type: "journal", year: 2024, topics: ["ecommerce", "service"], featured: false,
    ...
    {
      id: "j-2024-information-security-fatigue", type: "journal", year: 2024, topics: ["security", "hci"], featured: false,
    ...
    {
      id: "j-2023-social-media-fatigue", type: "journal", year: 2023, topics: ["hci"], featured: false,
    ...
    {
      id: "j-2022-intellectual-capital-team-resilience", type: "journal", year: 2022, topics: ["isd"], featured: false,
    ...
    {
      id: "t-sample-1", type: "thesis", year: 2024, topics: ["hci"], featured: false,
