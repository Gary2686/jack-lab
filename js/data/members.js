      ...
      members: [
        {
          ...
          bio: {
            zh: "徐士傑主任為 Jack Lab 指導教授，研究橫跨人工智慧與數位轉型、神經科學與人機互動、資訊安全、電子商務與數位服務、團隊與專案管理及模糊集質性比較分析，並長期投入哈佛教學個案與研究人才培育。（完整學術簡介待補充）",
            en: "Prof. Shih-Chieh Hsu, Chair of the department, leads Jack Lab with research spanning AI & digital transformation, neuroscience & HCI, information security, e-commerce & digital services, team & project management, and fuzzy-set QCA, with long-term dedication to Harvard teaching cases and mentoring researchers. (Full biography to be added.)",
          },
          email: "",
          scholar: "",
          website: "",
      ...
      members: [
        {
          ...
          interests: {
            zh: ["神經科學與人機互動", "服務科學", "資訊系統"],
            en: ["Neuroscience & HCI", "Service Science", "Information Systems"],
          },
          bio: {
            zh: "鄭鈞博士為 Jack Lab 博士後研究員，研究聚焦於神經科學與人機互動、服務科學與資訊系統相關議題。（學術簡介待補充）",
            en: "Dr. Jacob Cheng is a postdoctoral researcher at Jack Lab, focusing on neuroscience & HCI, service science, and information systems. (Biography to be added.)",
          },
          email: "",
          scholar: "",
          website: "",
      ...
      members: [
        {
          ...
          interests: {
            zh: ["AI 與數位轉型", "永續行動", "fsQCA"],
            en: ["AI & Digital Transformation", "Sustainable Action", "fsQCA"],
          },
          bio: {
            zh: "葉欲禾為 Jack Lab 博士候選人，研究興趣涵蓋 AI 與數位轉型、永續行動與質性比較分析方法。（學術簡介待補充）",
            en: "Gary Yu-Ho Yeh is a Ph.D. candidate at Jack Lab, with interests in AI & digital transformation, sustainable action, and qualitative comparative analysis. (Biography to be added.)",
          },
          email: "",
          scholar: "",
          website: "",
