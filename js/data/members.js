...
window.DATA.members = {
  groups: [
    ...
    },
    {
      ...
      members: [
        { id: "lin-jing-wei", name: { zh: "林京緯", en: "Lin Ching-Wei" }, photo: "assets/members/lin-jing-wei.jpg", email: "Brian91100795@gmail.com", pet: "bot" },
        { id: "lin-chen-wei", name: { zh: "林宸煒", en: "Lin Chen-Wei" }, photo: "assets/members/lin-chen-wei.jpg", email: "linwilson671@gmail.com", pet: "bird" },
        { id: "tseng-shu-huan", name: { zh: "曾書桓", en: "Zeng Shu-Huan" }, photo: "assets/members/tseng-shu-huan.jpg", email: "s392983978@gmail.com", pet: "frog" },
        { id: "wu-cheng-chien", name: { zh: "吳呈堅", en: "Wu Cheng-Jian" }, photo: "assets/members/wu-cheng-chien.jpg", email: "chengjianwu678@gmail.com", pet: "fish" },
        { id: "kung-sung-yu", name: { zh: "孔崧羽", en: "Kong Song-Yu" }, photo: "assets/members/kung-sung-yu.jpg", email: "kongsongyu9012@gmail.com", pet: "ghost" },
        { id: "li-yu-chen", name: { zh: "李瑀蓁", en: "Lee Yu-Chen" }, photo: "assets/members/li-yu-chen.jpg", email: "lyzchry1771@gmail.com", pet: "cat" },
        { id: "hsu-chih-hao", name: { zh: "徐稚皓", en: "Hsu Chih-Hao" }, photo: "assets/members/hsu-chih-hao.jpg", photoPosition: "center", email: "howard120330@gmail.com", pet: "bot" },
        { id: "su-wen-feng", name: { zh: "蘇彣丰", en: "Su Wen-Feng" }, photo: "assets/members/su-wen-feng.jpg", photoPosition: "center", email: "wenfeng.taipei@gmail.com", pet: "bird" },
      ],
    },
    {
      id: "alumni",
      ...
      members: [
        ...
        { id: "chien-yun-ting", name: { zh: "簡筠庭", en: "Chien Yun-Ting" }, photo: "", email: "", currentPosition: { zh: "", en: "" }, pet: "cat" },
        { id: "yang-chu-chun", name: { zh: "楊筑鈞", en: "Yang Chu-Chun" }, photo: "", email: "", currentPosition: { zh: "", en: "" }, pet: "fish" },
