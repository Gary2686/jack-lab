...
window.DATA.awards = {
  ...
  items: [
    {
      id: "a-1", type: "studentThesis", year: 2025, draft: true,
      title: { zh: "（範例）碩士論文獎", en: "(Sample) Outstanding Master's Thesis Award" },
      recipient: { zh: "Jack Lab 研究生", en: "Jack Lab graduate student" },
      org: { zh: "", en: "" },
      desc: { zh: "表彰於資訊管理領域之傑出碩士論文。", en: "Recognizing an outstanding master's thesis in IM." },
      image: "",
    },
    {
      id: "a-2", type: "competition", year: 2025, draft: true,
      title: { zh: "（範例）資料分析競賽 佳績", en: "(Sample) Data Analytics Competition — Award" },
      recipient: { zh: "Jack Lab 團隊", en: "Jack Lab team" },
      org: { zh: "", en: "" },
      desc: { zh: "於資料分析／服務設計相關競賽獲獎。", en: "Awarded in a data-analytics / service-design competition." },
      image: "",
    },
    {
      id: "a-3", type: "honor", year: 2024, draft: true,
      ...
      desc: { zh: "肯定於教學與研究上的貢獻。", en: "Recognizing contributions to teaching and research." },
      image: "",
    },
    {
      id: "a-4", type: "milestone", year: 2024, draft: true,
      title: { zh: "（範例）Jack Lab 神經科學實驗室建置", en: "(Sample) Neuroscience Lab Established" },
      recipient: { zh: "Jack Lab", en: "Jack Lab" },
      org: { zh: "國立中山大學 資訊管理學系", en: "Dept. of IM, NSYSU" },
      desc: { zh: "建置腦波與眼動實驗設備，啟動神經科學與人機互動研究。", en: "Set up EEG and eye-tracking facilities, launching neuroscience & HCI research." },
      image: "",
    },
  ],
};
